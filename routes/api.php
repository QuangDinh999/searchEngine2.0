...
Route::apiResource('video_search', \App\Http\Controllers\VideoController::class);
...
Route::apiResource('audio_search', \App\Http\Controllers\AudioSearchControllerController::class);
