...
{{--        <a class="navbar-brand brand-logo" href="{{ url('/transdetails/show') }}">--}}
...
{{--        </button>--}}
        <ul class="navbar-nav navbar-nav-right header-links">
            <li class="nav-item d-none d-xl-flex">
                <a href="{{route('transdetail.show')}}" class="nav-link">My Academic Transcript <span class="badge badge-primary ml-1">New</span>
                </a>
            </li>
{{--            <li class="nav-item active d-none d-lg-flex">--}}
{{--                <a href="{{route('report.index')}}" class="nav-link">--}}
{{--                    <i class="mdi mdi-fountain-pen-tip"></i>Reports about Score</a>--}}
{{--            </li>--}}
{{--            <li class="nav-item active d-none d-lg-flex">--}}
{{--                <a href="{{route('reexamine.show')}}" class="nav-link">--}}
{{--                    <i class="mdi mdi-resistor"></i>Reexamine Results</a>--}}
{{--            </li>--}}
...
{{--                    <a href="{{ route('transdetail.show') }}" class="dropdown-item"><i class="mdi mdi-bookmark-plus-outline"></i>Score</a>--}}
{{--                </div>--}}
{{--            </li>--}}
        </ul>
